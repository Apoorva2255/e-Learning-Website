<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.master" AutoEventWireup="true" CodeFile="frmListOfStudent.aspx.cs" Inherits="STD_ListOfAsignemnt" %>
...
<%--    <asp:DataList ID="DataList1" runat="server" BackColor="White" 
    ...
    <asp:GridView runat="server" ID="gvData" CellPadding="4" ForeColor="#333333" 
            GridLines="None" ShowFooter="True" ShowHeaderWhenEmpty="True" 
